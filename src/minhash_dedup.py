# Adopted from the BigCode project
# Refer to description at: https://huggingface.co/blog/dedup
...
if __name__ == "__main__":
    ...
    def run(
        ...
        map_parallelism: int = typer.Option(8, help="Number of processes to spawn for the map stage"),
        ...
        if num_samples:
            if num_samples < len(ds):
                ds = ds.shuffle(SEED).select(range(num_samples))
        DATA_SIZE = len(ds)
