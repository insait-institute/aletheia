...
defaults = [{"db": "cuf_success_rate_local"}]
...
cs.store(group="db", name="cuf_success_rate_local", node=LocalConfig)
cs.store(group="db", name="cuf_success_rate_openai", node=OpenAIConfig)
cs.store(name="cuf_success_rate_config", node=Config)
