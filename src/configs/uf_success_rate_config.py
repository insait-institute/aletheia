...
defaults = [{"db": "uf_success_rate_local"}]
...
cs.store(group="db", name="uf_success_rate_local", node=LocalConfig)
cs.store(group="db", name="uf_success_rate_openai", node=OpenAIConfig)
cs.store(name="uf_success_rate_config", node=Config)
