...
accelerate launch --config_file=configs/deepspeed/config.yaml thinkdpo_training.py model=thinkdpo/dsqwen_${model} method=thinkdpo gen_params.max_completion_length=${b_tr}
``` 
